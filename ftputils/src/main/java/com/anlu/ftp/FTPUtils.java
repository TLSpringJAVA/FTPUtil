...
public class FTPUtils {
    ...
    public ArrayList<String> arFiles = new ArrayList<>();//用于列出指定目录下的所有文件
    private String server = "192.168.1.82";
    private int port = 21;
    private String userName = "Yuan";
    private String userPassword = "fsy";
    ...
    public static  void main(String[] args) throws IOException {
        ...
        if(isOpen){
            //utils.upload("ftpFile/data", "changeLog.txt", "D://
            //boolean result= utils.upload("messageAim.properties", "/exam", "C:\\Users\\Administrator\\Desktop\\messages.properties");
